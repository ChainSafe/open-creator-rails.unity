...
namespace Io.ChainSafe.OpenCreatorRails.Contracts.ERC20Permit.Service
{
    public partial class ERC20PermitService: ERC20PermitServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, ERC20PermitDeployment eRC20PermitDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC20PermitDeployment>().SendRequestAndWaitForReceiptAsync(eRC20PermitDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, ERC20PermitDeployment eRC20PermitDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC20PermitDeployment>().SendRequestAsync(eRC20PermitDeployment);
        }

        public static async Task<ERC20PermitService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, ERC20PermitDeployment eRC20PermitDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eRC20PermitDeployment, cancellationTokenSource);
            return new ERC20PermitService(web3, receipt.ContractAddress);
        }

        public ERC20PermitService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class ERC20PermitServiceBase: ContractWeb3ServiceBase
    {

        public ERC20PermitServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
